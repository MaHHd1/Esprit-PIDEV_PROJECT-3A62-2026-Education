...
class EvaluationController extends AbstractController
{
    ...
    ): Response
    {
        ...
        $evaluations = $evaluationRepository->findBySearchAndSort($search, $sortBy, $order, $enseignant->getMatriculeEnseignant(), $page, $limit);
        
        // Compter le nombre total de résultats pour la pagination
        $totalEvaluations = $evaluationRepository->countBySearchAndSort($search, $enseignant->getMatriculeEnseignant());
    ...
    ): Response
    {
        ...
        $evaluation->setIdEnseignant($enseignant->getMatriculeEnseignant());
    ...
    ): Response
    {
        ...
        if ($evaluation->getIdEnseignant() !== $enseignant->getMatriculeEnseignant()) {
