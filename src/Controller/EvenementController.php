            ...
            try {
                ...
                while (($data = fgetcsv($handle, 1000, ';')) !== false) {
                    ...
                    $evenement->setTypeEvenement(
                        TypeEvenement::tryFrom(trim((string) ($data[2] ?? ''))) ?? TypeEvenement::WEBINAIRE
                    );
                    ...
                    $evenement->setStatut(
                        StatutEvenement::tryFrom(trim((string) ($data[7] ?? ''))) ?? StatutEvenement::PLANIFIE
                    );
                    $evenement->setVisibilite(
                        VisibiliteEvenement::tryFrom(trim((string) ($data[8] ?? ''))) ?? VisibiliteEvenement::PUBLIC
                    );
                    $evenement->setCreateur($user);
